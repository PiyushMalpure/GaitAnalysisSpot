...
from . WalkGaitController import WalkGaitController
...
class Robot(object):
    def __init__(self, body, legs, imu):
        ...
        self.crawlGaitController = WalkGaitController(self.default_stance,
        ...
        self.currentController = self.restController#self.trotGaitController
    ...
    def change_controller(self):
        ...
        elif True:#self.command.crawl_event:
            if self.state.behavior_state == BehaviorState.REST:
    ...
    def imu_orientation(self,msg):
        ...
        # rpy_angles = tf.transformations.euler_from_quaternion([i,0,0,0])#[q.x,q.y,q.z,q.w])
        self.state.imu_roll = 200#rpy_angles[0]
        self.state.imu_pitch = 200#rpy_angles[1]
